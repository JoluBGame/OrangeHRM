...
public class RecruitmentTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Enter.theValue("Primer Nombre").into(RecruitmentPage.TXT_FIRSTNAME));
        actor.attemptsTo(Enter.theValue("Segundo Nombre").into(RecruitmentPage.TXT_MIDDLENAME));
        actor.attemptsTo(Enter.theValue("Apellido").into(RecruitmentPage.TXT_LASTNAME));
        ...
        actor.attemptsTo(Enter.theValue("correo@pruebacorreo.com").into(RecruitmentPage.TXT_EMAIL));
        actor.attemptsTo(Enter.theValue("5555555").into(RecruitmentPage.TXT_CONTACTNUMBER));
        ...
        actor.attemptsTo(Enter.theValue("2024-28-08").into(RecruitmentPage.TXT_DATE));
