...
public class ScheduleInterviewTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue("Entrevista al candidato").into(ScheduleInterviewPage.TXT_INTERVIEWTITLE));
        actor.attemptsTo(Enter.theValue("manda").into(ScheduleInterviewPage.TXT_INTERVIEWER));
        try {
            Thread.sleep(2000);
       ...
       actor.attemptsTo(WaitElement.untilAppears(ScheduleInterviewPage.TXT_INTERVIEWER));
        ...
        actor.attemptsTo(Enter.theValue("2024-28-08").into(ScheduleInterviewPage.TXT_DATE));
        actor.attemptsTo(Enter.theValue("02:00 PM").into(ScheduleInterviewPage.TXT_TIME));
        actor.attemptsTo(Enter.theValue("Cualquier Nota").into(ScheduleInterviewPage.TXT_NOTESINTER));
